...
export default {
  ...
  methods: {
    ...mapActions(useMainStore, ["loggedInPost", "deletePost"]),
  },
  created() {
      ...
      <div class="card h-100">
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
          <div class="text-center">
            ...
            <a
              class="btn btn-outline-dark mt-auto mx-3"
              @click.prevent="deletePost(news.id)"
              >Delete</a
            >
          </div>
        </div>
    ...
    <ul class="pagination justify-content-center">
      <li class="page-item">
        <a
          class="page-link"
          href="#"
          @click.prevent="loggedInPost(currentPage - 1)"
          v-if="currentPage !== 1"
          >Previous</a
        >
      </li>
      <div class="" v-for="index in totalPages">
        <li class="page-item">
          <a class="page-link" @click.prevent="loggedInPost(index)">{{
            index
          }}</a>
        </li>
      </div>
